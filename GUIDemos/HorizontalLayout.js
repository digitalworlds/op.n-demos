...
/*
 This program demonstrates how to make and customize Horizontal Layouts using the HorizontalLayout class.
 */
var main=function(args)
{
	...
	layout.append(new Label("This is a horizontal layout composed of three buttons:"))




	//We create a horizontal layout to place the buttons.
	var horizonlayout=new HorizontalLayout();
	horizonlayout.appendCustomStyle(
	{
		applyStyle:(layout)=>
		{
			horizonlayout.div.style.padding="5px";
		}
	})
	
	//We add the horizontal layout to this app's window.
	args.app.getWindow().getContent().append(horizonlayout);
	...
	horizonlayout.append(button_1);

	var button_2=new Button("Button 2");
	horizonlayout.append(button_2);

	var button_3=new Button("Button 3");
	horizonlayout.append(button_3);
