...
/*
 This program demonstrates how to make and customize Radio Button Groups using the RadioButtonGroup class.
 */
var main=function(args)
{
	...
	layout.append(new Label("This is a Radio Button Group:"));
	
	//We first create a radio button group.

	var radioGroup=new RadioButtonGroup();
		//Add the individual radio buttons to the group
		radioGroup.append(new RadioButton("Radio Button 1"));
		radioGroup.append(new RadioButton("Radio Button 2"));
		radioGroup.append(new RadioButton("Radio Button 3"));
	

	//Then we add it to our layout.
	layout.append(radioGroup);
