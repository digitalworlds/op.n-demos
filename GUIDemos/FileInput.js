...
/*
 This program demonstrates how to make and customize a File Input using the FileInput class.
 */
var main=function(args)
{
	...
	//We create a layout to place the File Input.
	...
	layout.append(new Label("This is a File Input:"));
	
	//We first create a File Input.
	var fileInput = new FileInput();

	//Then we add it to our layout.
	layout.append(fileInput);
