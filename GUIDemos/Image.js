...
/*
 This program demonstrates how to make and customize Images using the Image class.
 */
var main=function(args)
{

	
	//We create a layout to place the Image.
	...
	layout.append(new Label("This is an image with a tip text:"));
	
	//We first create the image.
	var image=new Image();

	//There a few basic methods for this class
	//Here is the way to set a tool tip text and set the source of the image
	...
	image.setToolTipText("This is a cloud");


	//This is the way to change the style
	image.appendCustomStyle({
		applyStyle:function(image){
			image.div.style.minHeight='80px';
