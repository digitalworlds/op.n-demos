...
/*
 This program demonstrates how to make and customize Pop Up Layouts using the PopUpLayout class.
 */
var main=function(args)
{
	...
	layout.append(new Label("This is a pop up layout:"));
	var popLayout = new PopUpLayout();

	popLayout.appendCustomStyle({
		applyStyle:function(popLayout)
		{
			opn.set(popLayout.div.style,
				{
	...
	popLayout.append(new Label("this is working"));
	popLayout.append(new Label("How do we fill out the rest of this pop out window?"));
	
	//These functions make the layout appear and disappear
	popLayout.show();

	//popLayout.hide();

	//Add the pop up to the layout
	layout.append(popLayout);
